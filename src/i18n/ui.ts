...
export const ui = {
	es: {
		...
		'about.eyebrow': 'About',
		'about.headline': 'Ingeniería de software en formación, con foco en ',
		...
		'about.experienceCompany': 'Tamci',
		'about.experiencePeriod': '8 meses',
		'about.experienceDesc':
			'Backend con Spring Boot y frontend con Angular. Captura de requisitos con clientes y lógica de negocio.',
		'about.educationTitle': 'Educación',
		'about.educationSchool': 'Ingeniería de Software — UPC',
	...
	en: {
		...
		'about.eyebrow': 'About',
		'about.headline': 'Software engineer in the making, focused on ',
		...
		'about.experienceCompany': 'Tamci',
		'about.experiencePeriod': '8 months',
		'about.experienceDesc':
			'Backend with Spring Boot and frontend with Angular. Requirements gathering with clients and business logic.',
		'about.educationTitle': 'Education',
		'about.educationSchool': 'Software Engineering — UPC',
